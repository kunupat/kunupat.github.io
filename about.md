			    ...
			    <div class="media flex-column flex-md-row">
				    ...
				    <div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
					    <div class="primary-info">
						    <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">Kunal Patil</h1>
					    ...
					    <div class="secondary-info ml-md-auto">
						    <ul class="resume-social list-unstyled">
								...
								<li><a href="https://www.certmetrics.com/amazon/public/badge.aspx?i=1&t=c&d=2019-03-29&ci=AWS00828325"><span class="fa-container text-center mr-2"><i class="fab fa-aws"></i></span>AWS Certified Solutions Architect- Associate</a></li>
						    </ul>
					    </div><!--//secondary-info-->
				    ...
				    <div class="col-lg-3">
						    ...
						    <div class="resume-section-content">
						        <div class="resume-skill-item">
							        ...
							        <ul class="list-unstyled mb-4">
								        ...
								        <li class="mb-2">
								            <div class="resume-skill-name">JSF/PrimeFaces</div>
									        <div class="progress resume-progress">
								...
								<div class="resume-skill-item">
						            <h4 class="resume-skills-cat font-weight-bold">Integration</h4>
							        <ul class="list-unstyled">
										<li class="mb-2">
										...
										<li class="mb-2">
								            <div class="resume-skill-name">GraphQL</div>
									        <div class="progress resume-progress">
											    <div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 60%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
										</li>
										<li class="mb-2">
								            <div class="resume-skill-name">GRPC</div>
									        <div class="progress resume-progress">
											    <div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 50%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
								        </li>
								...
								<div class="resume-skill-item">
						            <h4 class="resume-skills-cat font-weight-bold">Cloud</h4>
							        <ul class="list-unstyled">
										<li class="mb-2">
										...
										<li class="mb-2">
								            <div class="resume-skill-name">Google Cloud Platform (GCP)</div>
									        <div class="progress resume-progress">
								...
								<div class="resume-skill-item">
						            <h4 class="resume-skills-cat font-weight-bold">Cloud Native & Integration Technologies</h4>
							        <ul class="list-unstyled">
										<li class="mb-2">
								            <div class="resume-skill-name">RedHat OpenShift Platform</div>
									        <div class="progress resume-progress">
											    <div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 60%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
								        </li>
										...
										<li class="mb-2">
								            <div class="resume-skill-name">Istio Service Mesh</div>
									        <div class="progress resume-progress">
											    <div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 30%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
										</li>
										<li class="mb-2">
								            <div class="resume-skill-name">Amazon AppMesh</div>
									        <div class="progress resume-progress">
											    <div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 30%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
								        </li>
										<li class="mb-2">
								            <div class="resume-skill-name">CloudFoundry</div>
									        <div class="progress resume-progress">
											    <div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 30%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
								        </li>
						        ...
						        <div class="resume-skill-item">
						            ...
						            <ul class="list-inline">
										...
										<li class="list-inline-item"><span class="badge badge-light">Maven</span></li>
										<li class="list-inline-item"><span class="badge badge-light">Gradle</span></li>
										<li class="list-inline-item"><span class="badge badge-light">SVN</span></li>
										<li class="list-inline-item"><span class="badge badge-light">Jenkins</span></li>
										<li class="list-inline-item"><span class="badge badge-light">Tekton</span></li>
										<li class="list-inline-item"><span class="badge badge-light">Terraform</span></li>
										<li class="list-inline-item"><span class="badge badge-light">Ansible</span></li>
										<li class="list-inline-item"><span class="badge badge-light">Java Design Patterns</span></li>
										<li class="list-inline-item"><span class="badge badge-light">Microservices Design Patterns</span></li>
					    ...
					    <section class="resume-section education-section mb-5">
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled">
								    <li class="mb-2">
								        <div class="resume-degree font-weight-bold">Bachelor of Engineering in Computer Science</div>
								        <div class="resume-degree-org">North Maharashtra University, India</div>
								        <div class="resume-degree-time">2002 - 2006</div>
								    </li>
							    </ul>
						    </div>
					    ...
					    <section class="resume-section language-section mb-5">
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled resume-lang-list">
								    ...
								    <li class="mb-2 align-middle"><span class="resume-lang-name font-weight-bold">Marathi</span> <small class="text-muted font-weight-normal">(Native)</small></li>
								    <li><span class="resume-lang-name font-weight-bold">Hindi</span> <small class="text-muted font-weight-normal">(Native)</small></li>
							    </ul>
						    </div>
